...
async function main() {
  ...
  await prisma.proyecto.create({
    data: { nombre: "Sitio Web Dental Smile", servicio: "SITIO_WEB_CORPORATIVO", estado: "REVISION", prioridad: "ALTA", fechaInicio: new Date(Date.now() - 25 * 86400000), fechaEntrega: new Date(Date.now() + 5 * 86400000), valor: 720000, horasEstimadas: 40, horasReales: 38, clienteId: c2.id, proximosPasos: "Correcciones feedback cliente." },
  })
